...
Config.RealWeapons = {
	...
	{name = 'WEAPON_NIGHTSTICK', 		bone = 24818, x = 65536.0, y = 65536.0, z = 65536.0, xRot = 0.0, yRot = 0.0, zRot = 0.0, category = 'melee', 		model = 'w_me_nightstick'},
	 ...
	 {name = 'WEAPON_PISTOL_MK2', 			bone = 51826, x = -0.01, y = 0.10, z = 0.07,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_pistol'},
	...
	{name = 'WEAPON_PISTOL50', 			bone = 51826, x = -0.08, y = 0.06, z = 0.09,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_pistol50'},
	-- {name = 'WEAPON_PISTOL50', 			bone = 51826, x = -0.10, y = 0.08, z = 0.07,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_pistol50'},
